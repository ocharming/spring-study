...
//@RestController(@Controller + @ResponseBody 나중에 완성후 바꾸세요...)
@Controller
...
//      memoDto.setName(memberDto.getName());
  ...
  @RequestMapping(value = "memo/{seq}", method = RequestMethod.GET, headers = {"Content-type=application/json"})
...
//      memoDto.setName(memberDto.getName());
  ...
  @RequestMapping(value = "memo/{seq}/{mseq}", method = RequestMethod.DELETE, headers = {"Content-type=application/json"})
