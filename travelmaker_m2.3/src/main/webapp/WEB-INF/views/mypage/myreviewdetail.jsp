...
<input type="hidden" id="writeman" value="${sessionScope.m_Email}">
    	...
    	<div class="container text-center">
          ...
          <div><div class="figure lead text-muted text-small float-left">글번호 : <span id="t_Num">${list.t_Num}</span></div><div class="figure lead text-muted text-small float-right">작성일 : ${list.t_Regdate}, 조회수 : ${list.t_Hit}
          
          
          , 좋아요 : 
          
          <span id="likecount">${likecount}</span></div>
